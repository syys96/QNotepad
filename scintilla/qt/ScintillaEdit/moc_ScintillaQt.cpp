...
void Scintilla::ScintillaQt::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ScintillaQt *_t = static_cast<ScintillaQt *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ScintillaQt::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScintillaQt::horizontalScrolled)) {
                *result = 0;
            }
        }
        {
            typedef void (ScintillaQt::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScintillaQt::verticalScrolled)) {
                *result = 1;
            }
        }
        {
            typedef void (ScintillaQt::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScintillaQt::horizontalRangeChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (ScintillaQt::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScintillaQt::verticalRangeChanged)) {
                *result = 3;
            }
        }
        {
            typedef void (ScintillaQt::*_t)(SCNotification );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScintillaQt::notifyParent)) {
                *result = 4;
            }
        }
        {
            typedef void (ScintillaQt::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScintillaQt::notifyChange)) {
                *result = 5;
            }
        }
        {
            typedef void (ScintillaQt::*_t)(QMimeData * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScintillaQt::aboutToCopy)) {
                *result = 6;
            }
        }
        {
            typedef void (ScintillaQt::*_t)(uptr_t , sptr_t );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScintillaQt::command)) {
                *result = 7;
            }
        }
    }
...
const QMetaObject Scintilla::ScintillaQt::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Scintilla__ScintillaQt.data,
      qt_meta_data_Scintilla__ScintillaQt,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Scintilla::ScintillaQt::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Scintilla__ScintillaQt.stringdata0))
        return static_cast<void*>(const_cast< ScintillaQt*>(this));
    if (!strcmp(_clname, "ScintillaBase"))
        return static_cast< ScintillaBase*>(const_cast< ScintillaQt*>(this));
