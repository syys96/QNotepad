...
void ScintillaDocument::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ScintillaDocument *_t = static_cast<ScintillaDocument *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ScintillaDocument::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScintillaDocument::modify_attempt)) {
                *result = 0;
            }
        }
        {
            typedef void (ScintillaDocument::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScintillaDocument::save_point)) {
                *result = 1;
            }
        }
        {
            typedef void (ScintillaDocument::*_t)(int , int , const QByteArray & , int , int , int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScintillaDocument::modified)) {
                *result = 2;
            }
        }
        {
            typedef void (ScintillaDocument::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScintillaDocument::style_needed)) {
                *result = 3;
            }
        }
        {
            typedef void (ScintillaDocument::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScintillaDocument::lexer_changed)) {
                *result = 4;
            }
        }
        {
            typedef void (ScintillaDocument::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScintillaDocument::error_occurred)) {
                *result = 5;
            }
        }
    }
...
const QMetaObject ScintillaDocument::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ScintillaDocument.data,
      qt_meta_data_ScintillaDocument,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ScintillaDocument::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScintillaDocument.stringdata0))
        return static_cast<void*>(const_cast< ScintillaDocument*>(this));
